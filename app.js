...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getByClass; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hbs_index_hbs__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hbs_index_hbs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__hbs_index_hbs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_style_scss__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_getMyInfo_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_ga_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__ = __webpack_require__(42);
...
var test_status_nodes = Object(__WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["a" /* getByClass */])("js-test-status");
var test_link_nodes = Object(__WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["a" /* getByClass */])("js-test-link");
var test_subtitle_node = Object(__WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["a" /* getByClass */])("js-test-subtitle")[0];

var auto_test = {
    node: Object(__WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["a" /* getByClass */])("js-reload-rate")[0],
    rate: ([0, 2, 5, 15, 30].indexOf(parseInt(__WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["b" /* storage */].get("auto-test"))) > -1
        ? parseInt(__WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["b" /* storage */].get("auto-test")) : 15),
    timeout: 0
};
...
function runTest() {
    ...
    __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].ua(navigator.userAgent);
    ...
    var ipAddr = Object(__WEBPACK_IMPORTED_MODULE_2__js_getMyInfo_js__["a" /* default */])().then((result) => {
        // test successful
        test_success = true;
        __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].ip(result.ip);
        __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].ping(Date.now() - test_time);
        __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].location(result.loc);

    }).catch((e) => {
        // test failed
        test_success = false;
        __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].ip(null);
        __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].ping(null);
        __WEBPACK_IMPORTED_MODULE_5__js_infobox_js__["a" /* default */].location(null);
        ...
        document.title = `${"Is My Internet Working?"} ${test_status}`;
...
function main() {
    ...
    auto_test.node.addEventListener("change", function(e) {
        ...
        clearTimeout(auto_test.timeout);
        if (auto_test.rate > 0) auto_test.timeout = setTimeout(runTest, auto_test.rate * 1000);
        __WEBPACK_IMPORTED_MODULE_4__js_domHelpers_js__["b" /* storage */].set("auto-test", auto_test.rate);
    });

    runTest();
    console.log(`Your Console Works! Build Type: ${"production|dev"} : ${"١٦‏/٨‏/٢٠٢٥، ٧:٥٣:٥١ ص"}`);
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!DOCTYPE html>\r\n<html>\r\n\r\n<head>\r\n    <title>Is My Internet Working?</title>\r\n"
    + ((stack1 = container.invokePartial(__webpack_require__(25),depth0,{"name":"meta","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</head>\r\n\r\n<body>\r\n"
    + ((stack1 = container.invokePartial(__webpack_require__(26),depth0,{"name":"menubar","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    <div id=\"center\">\r\n        <div class=\"test-info-wrapper\">\r\n            <div id=\"yesbox\">\r\n                <div id=\"yestext\" class=\"grow noselect\">\r\n                    <a id=\"yeslink\" class=\"js-test-status orange\" title=\"Click here to test again!\">\r\n                        MAYBE\r\n                    </a>\r\n                </div>\r\n                <div id=\"yessub\" class=\"js-test-subtitle\">\r\n                    Just a moment, I'm checking...\r\n                </div>\r\n            </div>\r\n            <div class=\"hr\" style=\"margin: 0\"></div>\r\n"
    + ((stack1 = container.invokePartial(__webpack_require__(27),depth0,{"name":"info","data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "        </div>\r\n        <p class=\"question\">\r\n            Having connection problems? Start here.</p>\r\n        <p class=\"answer\">\r\n            Favorite website down? Animated gifs loading slowly? You're in the right place. This site is more than just an Internet connection tester - it's also a comprehensive\r\n            walkthrough for troubleshooting your Internet connection. Test your connection as you make changes\r\n            (<a href=\"javascript:void(0)\" class=\"js-test-link\">click the banner!</a>) without having to refresh the page. You can check the uptime and performance of a particular website using these tools:\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li><a href=\"https://isitdownorjust.me/\" target=\"_blank\">Is it Down or Just Me?</a>: Check to see if a site is down for everyone, or if it's just you. If it's you\r\n                (or that site is also inaccessible), keep on reading. Alternative: <a href=\"http://www.downforeveryoneorjustme.com/\"\r\n                target=\"_blank\" title=\"Down For Everyone Or Just Me?\">Down for Everyone or Just Me?</a>\r\n                <li><a href=\"http://tools.pingdom.com/fpt/\" target=\"_blank\">Pingdom Website Speed Test</a>: Run a third-party speed test against another website. The website could be up, but just under high load and slow to respond. Alternative: <a href=\"https://gtmetrix.com/\" target=\"_blank\">GTmetrix's Speed Test.</a></li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            Any visible <a href=\"http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html\"\r\n                target=\"_blank\">HTTP status codes</a> such as 301 or 404 generally indicate that a website is online, but temporarily inaccessible (try a different URL?).\r\n                Should your browser fail to connect altogether, consider clearing your DNS cache, which is responsible for mapping domain names (e.g. \"ismyinternetworking.com\") to IP addresses.\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li><b>Windows</b> users: Open a command prompt window, and run the command \"<b>ipconfig /flushdns</b>\".</li>\r\n                <li><b>macOS/OSX 10.10+</b> users: In a terminal window, use \"<b>sudo killall -HUP mDNSResponder</b>\".\r\n                On older versions of OSX, try \"<b>sudo discoveryutil mdnsflushcache</b>\" or \"<b>sudo dscacheutil -flushcache</b>\". These commands will require elevated (administrator) permissions.</li>\r\n                <li><b>Linux</b> users: your DNS is likely managed by\r\n                    <b>nscd daemon</b>. In a terminal window, try the commands \"<b>/etc/rc.d/nscd restart</b>\" or \"<b>/etc/init.d/nscd restart</b>\".\r\n                </li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            DNS is usually provided by your Internet Service Provider (ISP), but you can try a different DNS provider by (temporarily)\r\n            <a\r\n                href=\"https://208.69.38.205/\" target=\"_blank\">switching to OpenDNS</a>. If that URL doesn't\r\n                work (which is an IP address and should not require a DNS lookup), then it's unlikely a DNS issue.\r\n        </p>\r\n        <p class=\"question\">\r\n            What can I do to make my connection faster?</p>\r\n        <p class=\"answer\">\r\n            Your Internet connection's maximum bandwidth is ultimately dictated by your ISP, but if you're not reaching that limit, there are a number of strategies\r\n            you can employ to make your connection faster. Wireless signals can be improved by simply physically relocating closer to the access point.\r\n            Better hardware can also improve signal and connection strength: an <a href=\"http://amzn.to/2nKnZGk\" target=\"_blank\">802.11 AC Wifi Router</a> or\r\n            <a href=\"http://amzn.to/2sf2Ys0\" target=\"_blank\">range extender</a>, when paired with an <a href=\"http://amzn.to/2sih5wv\" target=\"_blank\">802.11 AC Wifi Adapter</a>,\r\n            can offer significant improvements in range and bandwidth over older generations of Wifi. For immediate improvements,\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li>Pause or stop any active downloads or applications that could be hogging bandwidth.</li>\r\n                <li>Make sure the hotspot you are connecting to is secured - refer to your router's manual on how to set up a\r\n                    password (using <b>WPA2</b> encryption, not WEP, which is unsafe). Unsecured networks can be accessed by just about anybody, clogging up available bandwidth.</li>\r\n                <li>Restart your Wifi adapter by turning it on and off, or unplugging it and plugging it back in.\r\n                <li>Restart your router manually by unplugging it and plugging it back in after 30 seconds. Sometimes routers\r\n                    just need a fresh reboot to get things going again.</li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            If none of the above options work for you, or if you're using a wired connection, try the following:\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li>Unplug and plug back in your WiFi adapter (if external) or Ethernet cable.</li>\r\n                <li>Update your Wifi card or Ethernet port drivers. These should be available on your computer's manufacturer's website\r\n                    (e.g. <a href=\"https://www.asus.com/support/\" target=\"_blank\">ASUS Support</a>, <a href=\"https://www.netgear.com/support/download/\" target=\"_blank\">Netgear Download Center</a>,\r\n                    <a href=\"http://www.tp-link.com/us/support/download-center\" target=\"_blank\">TP-Link Download Center</a>).</li>\r\n                <li>Check to see if you have not exceeded your data usage cap, if you have one. Some ISPs will still allow you\r\n                    to access the internet after exceeding data usage limits, with a severe speed penalty.</li>\r\n                <li>Purchase more bandwidth from your ISP, at an increased cost.</li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            You can test your Internet speed via\r\n            <a href=\"http://www.speedtest.net/\" target=\"_blank\">Speedtest.net</a>,\r\n            <a href=\"http://www.speakeasy.net/speedtest/\" target=\"_blank\">Speakeasy's Speed Test</a>, or <a href=\"https://speedof.me/m/\" target=\"_blank\">SpeedOf.Me's Mobile Speed Test</a>.\r\n        </p>\r\n        <p class=\"question\">\r\n            What if nothing loads at all?</p>\r\n        <p class=\"answer\">\r\n            Any one of the components that bridge your computer to the internet could be broken, so you'll may have to diagnose each one\r\n            individually. If your hardware configuration hasn't changed recently, it could very well be a software issue. Listed below are some potential fixes\r\n            for temporary software problems that can get you back on track.\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li>Try a\r\n                    <a href=\"http://portableapps.com/apps/internet/google_chrome_portable\" target=\"_blank\">different web browser</a>, preferably one\r\n                    <a href=\"http://portableapps.com/apps/internet/firefox_portable\"\r\n                        target=\"_blank\">without addons/extensions</a> installed.\r\n                </li>\r\n                <li>Windows only: Right-click on the connection icon in the taskbar tray and select \"Troubleshoot Problems\" to\r\n                    see if Windows can solve the issue for you.</li>\r\n                <li>Restart your computer. No, really! On both wireless and wired connections, this will force your router to re-assign\r\n                    dynamic IP address to your computer.\r\n                </li>\r\n                <li>Connect to a different wireless hotspot, such as one created by your smartphone through tethering. Failure\r\n                    to connect to any other hotspot indicates an issue with the adapter.</li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            If none of the previous fixes work, it's time to start investigating hardware problems. The actions below\r\n            go over the hardware components that could be preventing you from connecting to the Internet.\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li>Examine the lights on your router or modem. Green = good, red = bad, and flashing indicates activity. The\r\n                    manual for your router or modem will have more information regarding what status the lights indicate.\r\n                    <li>Check to see if the cables, including power, that link your router, modem, and the wall are secure. Unplug and re-plug them.</li>\r\n                    <li>Restart your router or modem manually by unplugging it from power and plugging it back in after 30 seconds. Sometimes routers\r\n                        just need a fresh reboot to get things going again.</li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"question\">\r\n            How do I determine if my router is working?\r\n        </p>\r\n        <table>\r\n            <thead style=\"font-weight:bold\">\r\n                <tr>\r\n                    <td style=\"text-align:left;background:#fc9a5b\">Manufacturer/Source</td>\r\n                    <td style=\"background:#ffd248\">IP Address</td>\r\n                    <td colspan=\"2\" style=\"background:#8fd062\">Username/Password</td>\r\n                    <td colspan=\"2\" style=\"background:#c6f4a6\">Alt. Username/Password</td>\r\n                </tr>\r\n            </thead>\r\n            <tbody>\r\n                <tr>\r\n                    <td style=\"text-align:left\">2Wire Gateway (AT&T U-Verse)</td>\r\n                    <td>192.168.1.254</td>\r\n                    <td colspan=\"2\">Located on router</td>\r\n                    <td>(blank)</td>\r\n                    <td>(blank)</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">Arris (Comcast Xfinity)</td>\r\n                    <td>192.168.0.1</td>\r\n                    <td>admin</td>\r\n                    <td>password</td>\r\n                    <td>admin</td>\r\n                    <td>1234</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">Arris (Comcast Xfinity) alt.</td>\r\n                    <td>10.0.0.1</td>\r\n                    <td>comcast</td>\r\n                    <td>(blank)</td>\r\n                    <td>(blank)</td>\r\n                    <td>(blank)</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">ASUS</td>\r\n                    <td>192.168.1.1</td>\r\n                    <td>admin</td>\r\n                    <td>admin</td>\r\n                    <td>root</td>\r\n                    <td>root</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">Belkin</td>\r\n                    <td>192.168.2.1</td>\r\n                    <td>(blank)</td>\r\n                    <td>(blank)</td>\r\n                    <td>admin</td>\r\n                    <td>admin</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">D-Link</td>\r\n                    <td>192.168.0.1</td>\r\n                    <td>admin</td>\r\n                    <td>admin OR (blank)</td>\r\n                    <td>user</td>\r\n                    <td>(blank)</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">Linksys</td>\r\n                    <td>192.168.1.1</td>\r\n                    <td>admin</td>\r\n                    <td>admin</td>\r\n                    <td>(blank)</td>\r\n                    <td>admin</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">NETGEAR</td>\r\n                    <td>192.168.0.1</td>\r\n                    <td>admin</td>\r\n                    <td>admin OR password</td>\r\n                    <td colspan=\"2\">Refer to manual</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">Pace (AT&T U-Verse)</td>\r\n                    <td>192.168.1.254</td>\r\n                    <td colspan=\"2\">Located on router</td>\r\n                    <td>admin</td>\r\n                    <td>admin</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">Securifi</td>\r\n                    <td>10.10.10.254</td>\r\n                    <td colspan=\"2\">PIN: 1234</td>\r\n                    <td>admin</td>\r\n                    <td>admin</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">TP-Link</td>\r\n                    <td>192.168.1.1</td>\r\n                    <td>admin</td>\r\n                    <td>admin</td>\r\n                    <td>root</td>\r\n                    <td>admin</td>\r\n                </tr>\r\n                <tr>\r\n                    <td style=\"text-align:left\">TRENDnet</td>\r\n                    <td>192.168.1.1</td>\r\n                    <td>admin</td>\r\n                    <td>admin OR password</td>\r\n                    <td>(blank)</td>\r\n                    <td>(blank)</td>\r\n                </tr>\r\n            </tbody>\r\n        </table>\r\n        <p class=\"answer\">\r\n            Try to access your router's control panel via your browser (192.168.*.*) on a wired connection. In the table above, you can\r\n            find control panel IP addresses for common router manufacturers under the \"IP Address\" column. Alternatively,\r\n            you can find it in your router's manual. Type the IP address into the address bar of your browser, press enter, and the control panel page should appear.\r\n            If the IP address of your router is not listed above or doesn't work, try the following:\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li><b>Windows</b> users: Open a command prompt window, and run the command \"<b>ipconfig</b>\". Look for the \"Default Gateway\" line.</li>\r\n                <li><b>Linux/macOS</b> users: In a terminal window, run \"<b>route -n</b>\". Look for an IP address under the \"Gateway\" column.</li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            When prompted for a username and password, try a combination of (blank), \"root\", and \"admin\". Default usernames\r\n            and passwords for common router manufacturers can be found in the above reference table. The alternative\r\n            username/password combination is used less often.\r\n        </p>\r\n        <p class=\"answer\">\r\n            If the control panel says something similar to \"Searching for Server\" or \"First-time Setup\", then your ISP is having issues.\r\n            Consider <a href=\"http://gethuman.com/\" target=\"_blank\">giving them a call</a> to see if they are aware of connectivity problems on their end.\r\n            A support number can be located on your latest internet bill. Otherwise, if the control panel page never loads (with no login\r\n            prompt), and you're absolutely certain about the address, consider trying another router. This is\r\n            rather time consuming, but can determine if your router is at fault or your ISP is at fault.\r\n        <p class=\"answer\">Online, or at your local electronics store, you can find fully capable routers ranging anywhere from <a href=\"http://amzn.to/2smzdpc\" target=\"_blank\">cheap</a> to <a href=\"http://amzn.to/2CbqnKD\" target=\"_blank\">expensive.</a>\r\n            If a brand new router fails to connect as well, the issue is likely due to your ISP and your router(s) are perfectly fine. If the new one connects, your\r\n            old router is having problems, you can stick with your newly purchased one (or return it for a\r\n            <a href=\"http://amzn.to/2G5nYU5\"\r\n                target=\"_blank\">higher-end router</a>).</p>\r\n        <p class=\"answer\">Alternatively, as a last resort, you can try to fix your existing router one with a hard reset that restores it to factory settings.\r\n            Warning: This operation is <span style=\"font-weight: bold; color: red;\">irrevocable</span> and your old router settings will be permanently deleted, so we recommend\r\n            one more series of reboots before attempting a reset. Begin by locating the reset button on your router, which may be underneath or in the back, and will likely\r\n            require a paperclip to push in. You have two options (taken from the\r\n            <a href=\"http://www.dd-wrt.com/wiki/index.php/Reset_And_Reboot\"\r\n                target=\"_blank\">DD-WRT Wiki</a>), have a stopwatch ready:\r\n        </p>\r\n        <div class=\"list\">\r\n            <ul class=\"bodylist\">\r\n                <li>\"30 Reset\" - Press and hold the reset button for 30 seconds while the router is fully booted and on.</li>\r\n                <li>\"30/30/30 Reset\" - Press and hold the reset button for 30 seconds while the router is fully booted and on.\r\n                    Then, unplug the router while still holding down the reset button for 30 seconds. With the reset button\r\n                    still being held, plug the router back in for 30 seconds.</li>\r\n            </ul>\r\n        </div>\r\n        <p class=\"answer\">\r\n            Performing a hard reset will require you to set up your router again. Refer to your router's manual for details.\r\n        </p>\r\n        <p class=\"question\">I've tried everything above and I still don't have a stable connection!</p>\r\n        <p class=\"answer\">\r\n            No amount of restarting and updating can make up for a poor quality connection provided by your ISP. Temporary setbacks are usually resolved within a day or two,\r\n            but if you continue to experience regular disconnects, consider switching to a different ISP. \r\n            <a href=\"https://www.consumerreports.org/products/internet-providers/ratings-overview/\" target=\"_blank\">Consumer Reports</a> offers a scored ranking of ISPs based on several critera.\r\n            <a href=\"http://www.dslreports.com/reviews\" target=\"_blank\">DSLReports</a> offers consumer ISP reviews that can be narrowed down to your region.\r\n        </p>\r\n        <div class=\"hr\" style=\"margin: 0\"></div>\r\n"
    + ((stack1 = container.invokePartial(__webpack_require__(28),depth0,{"name":"footer","data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "    </div>\r\n        <script src=\"https://eyadalahmar.github.io/IsMyInternetWorking-updated/app.js\"></script>\r\n</body>\r\n</html>";
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<meta name=\"description\" content=\"Yes, it is! A handy utility and reference that offers a wealth of free tips on speeding up, troubleshooting, and repairing your Internet connection.\" />\r\n<!-- Facebook meta tags -->\r\n<meta property=\"og:title\" content=\"Is My Internet Working?\"/>\r\n<meta property=\"og:type\" content=\"website\"/>\r\n<meta property=\"og:url\" content=\"http://www.ismyinternetworking.com\"/>\r\n<meta property=\"og:image\" content=\"http://www.ismyinternetworking.com/image.png\"/>\r\n<meta property=\"og:description\" content=\"Yes, it is! A handy reference that offers a wealth of free tips on speeding up, troubleshooting, and repairing your Internet connection.\"/>\r\n<!-- Twitter meta tags -->\r\n<meta name=\"twitter:card\" content=\"summary\">\r\n<meta name=\"twitter:title\" content=\"Is My Internet Working?\">\r\n<meta name=\"twitter:description\" content=\"Yes, it is! A handy reference that offers a wealth of free tips on speeding up, troubleshooting, and repairing your Internet connection.\">\r\n<meta name=\"twitter:image\" content=\"http://www.ismyinternetworking.com/image.png\">\r\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"infobox\">\r\n    <div class=\"infobox-panel infobox-ip infobox-left\">\r\n        <div>\r\n            <div class=\"infobox-title\">IP ADDRESS</div>\r\n            <div class=\"infobox-content infobox-content-ip\">N/A</div>\r\n            <div class=\"infobox-subtitle\">prev \r\n                <span class=\"infobox-content-ip-prev\">\r\n                    <script>\r\n                        document.write(window.localStorage.getItem(\"infobox-prev-ip\") || \"N/A\");\r\n                    </script>\r\n                </span>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"infobox-panel infobox-loc infobox-right\">\r\n        <div>\r\n            <div class=\"infobox-title\">ESTIMATED LOCATION</div>\r\n            <div class=\"infobox-content infobox-content-loc\">N/A</div>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div class=\"infobox\">\r\n    <div class=\"infobox-panel infobox-ping infobox-left\">\r\n        <div>\r\n            <div class=\"infobox-title\">PING</div>\r\n            <div class=\"infobox-content infobox-content-ping\">N/A</div>\r\n            <div class=\"infobox-subtitle\">ip avg <span class=\"infobox-content-ping-avg\">N/A</span></div>\r\n        </div>\r\n    </div>\r\n    <div class=\"infobox-panel infobox-ua infobox-right\">\r\n        <div>\r\n            <div class=\"infobox-title\">USER AGENT</div>\r\n            <div class=\"infobox-content infobox-content-ua\">\r\n                <script>\r\n                    if (navigator.userAgent.length > 80) {\r\n                        document.getElementsByClassName(\"infobox-content-ua\")[0]\r\n                            .classList.add(\"infobox-content-small\");\r\n                    }\r\n                    document.write(navigator.userAgent);\r\n                </script>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<p class=\"footer\">\r\n    &copy; Copyright 2011-<script>document.write((new Date()).getFullYear());</script> Is My Internet Working. \r\n    Written and maintained by Brian Cui. Is My Internet Working is not to be held responsible for\r\n    any incidental, consequential, or indirect damages from the information written on this website. We cannot guarantee\r\n    that everything on here is perfectly safe. By following the guides on this site you assume total responsibility and risk\r\n    of possible damages.\r\n</p>\r\n<p class=\"footer\">Location data provided courtesy of\r\n    <a href=\"https://freegeoip.net/\" target=\"_blank\">freegeoip.net</a>. \r\n    No user location data acquired from these sources is ever stored by this website to respect your privacy.\r\n</p>\r\n<p class=\"footer\" style=\"text-align: center;\">\r\n    <b>v3.0.0 \"Revolution\" | Last updated 02/13/2018.</b>\r\n    <br>Please forward fanmail, complaints, and cat videos to yourwebsiteworks [at] gmail /dot/ com.\r\n</p>";
},"useData":true});
...
// module
exports.push([module.i, ".noselect{-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}/*! normalize.css v6.0.0 | MIT License | github.com/necolas/normalize.css */html{line-height:1.15;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%}article,aside,footer,header,nav,section{display:block}h1{font-size:2em;margin:.67em 0}figcaption,figure,main{display:block}figure{margin:1em 40px}hr{box-sizing:content-box;height:0;overflow:visible}pre{font-family:monospace,monospace;font-size:1em}a{background-color:rgba(0,0,0,0);-webkit-text-decoration-skip:objects}abbr[title]{border-bottom:none;text-decoration:underline;text-decoration:underline dotted}b,strong{font-weight:inherit}b,strong{font-weight:bolder}code,kbd,samp{font-family:monospace,monospace;font-size:1em}dfn{font-style:italic}mark{background-color:#ff0;color:#000}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-0.25em}sup{top:-0.5em}audio,video{display:inline-block}audio:not([controls]){display:none;height:0}img{border-style:none}svg:not(:root){overflow:hidden}button,input,optgroup,select,textarea{margin:0}button,input{overflow:visible}button,select{text-transform:none}button,html [type=button],[type=reset],[type=submit]{-webkit-appearance:button}button::-moz-focus-inner,[type=button]::-moz-focus-inner,[type=reset]::-moz-focus-inner,[type=submit]::-moz-focus-inner{border-style:none;padding:0}button:-moz-focusring,[type=button]:-moz-focusring,[type=reset]:-moz-focusring,[type=submit]:-moz-focusring{outline:1px dotted ButtonText}legend{box-sizing:border-box;color:inherit;display:table;max-width:100%;padding:0;white-space:normal}progress{display:inline-block;vertical-align:baseline}textarea{overflow:auto}[type=checkbox],[type=radio]{box-sizing:border-box;padding:0}[type=number]::-webkit-inner-spin-button,[type=number]::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}[type=search]::-webkit-search-cancel-button,[type=search]::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}details,menu{display:block}summary{display:list-item}canvas{display:inline-block}template{display:none}[hidden]{display:none}.sc-btn{display:inline-block;position:relative;padding:0;color:#fff;font-family:\"Helvetica Neue\",\"Helvetica\",sans-serif;font-size:14px;font-weight:400;line-height:1em;text-decoration:none;text-shadow:rgba(0,0,0,.3) 0 -0.1em 0;border:0;border-radius:.4em;-webkit-border-radius:.4em;-moz-border-radius:.4em;-ms-border-radius:.4em;-o-border-radius:.4em;background-color:#1a1a1a;background-image:-webkit-linear-gradient(top, #595959, #1a1a1a 100%);background-image:-moz-linear-gradient(top, #595959, #1a1a1a);background-image:-ms-linear-gradient(top, #595959, #1a1a1a);background-image:-o-linear-gradient(top, #595959, #1a1a1a);background-image:linear-gradient(top, #595959, #1a1a1a);text-align:center;background-repeat:no-repeat;-webkit-transition:background-position .1s ease-in-out;-webkit-appearance:none;cursor:pointer;overflow:hidden}.sc-btn a:link,.sc-btn:hover{color:#fff}.sc-btn:active{box-shadow:hsla(0,0%,100%,.2) 0 .1em 0,inset rgba(0,0,0,.3) 0 .25em 1em}.sc-icon,.sc-text{display:block;float:left}.sc-icon{margin:0 -0.25em 0 0;padding:.6em .8em .5em;border-right:hsla(0,0%,100%,.1) .1em solid;box-shadow:inset rgba(0,0,0,.1) -0.1em 0 0}.sc-text{padding:.95em 1em .85em;font-size:1.15em;text-align:center}svg{width:1.8em;height:1.8em;fill:#fff}.sc-block{display:block}.sc--big{font-size:24px}.sc--small{font-size:12px}.sc--tiny{font-size:8px}.sc--tiny .sc-text{padding:.58em .8em;font-size:1.4em;text-shadow:rgba(0,0,0,.3) 0 -1px 0}.sc--tiny .sc-icon{padding:.5em .75em;border-right:hsla(0,0%,100%,.1) 1px solid;box-shadow:inset rgba(0,0,0,.1) -1px 0 0}.sc--short .sc-icon{padding:.4em .9em .35em}.sc--short .sc-text{padding:.75em 1em}.sc--tall{font-size:1.15em}.sc--tall .sc-icon{padding:1em .9em .85em}.sc--tall .sc-text{padding:1.25em 1em 1em}.sc--round{border-radius:5em;-webkit-border-radius:5em;-moz-border-radius:5em;-ms-border-radius:5em;-o-border-radius:5em}.sc--round .sc-icon{padding:.7em .8em .5em 1em}.sc--flat{box-shadow:none;background-image:none !important}.sc--flat .sc-icon{border-color:rgba(0,0,0,0)}.sc--flat:active{box-shadow:inset rgba(0,0,0,.3) 0 .15em .25em}.sc--shine{box-shadow:inset rgba(0,0,0,.1) 0 -0.15em 0px,inset hsla(0,0%,100%,.1) 0 .15em 0px,rgba(0,0,0,.3) 0 .1em .3em,inset hsla(0,0%,100%,.15) 0 2.5em 0 -1em}.sc--shine:active{box-shadow:hsla(0,0%,100%,.2) 0 .1em 0,inset rgba(0,0,0,.3) 0 .25em 1em,inset hsla(0,0%,100%,.1) 0 2.5em 0 -1em}.sc--shine:before,.sc--shine:after{content:\"\";display:block;position:absolute;width:100%;height:.1em}.sc--shine:before{top:0;background-image:-webkit-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.3) 20%, rgba(255, 255, 255, 0) 100%);background-image:-moz-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.3) 20%, rgba(255, 255, 255, 0) 100%);background-image:-o-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.3) 20%, rgba(255, 255, 255, 0) 100%);background-image:-ms-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.3) 20%, rgba(255, 255, 255, 0) 100%);background-image:linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.3) 20%, rgba(255, 255, 255, 0) 100%)}.sc--shine:after{bottom:.05em;background-image:-webkit-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0) 100%);background-image:-moz-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0) 100%);background-image:-o-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0) 100%);background-image:-ms-linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0) 100%);background-image:linear-gradient(left, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0.1) 80%, rgba(255, 255, 255, 0) 100%)}.sc--shine:active:before,.sc--shine:active:after{opacity:.5}.sc--default{color:#222;text-shadow:hsla(0,0%,100%,.4) 0 .1em 0;background-color:#ebebeb;background-image:-webkit-linear-gradient(top, white, #ebebeb 100%);background-image:-moz-linear-gradient(top, white, #ebebeb);background-image:-ms-linear-gradient(top, white, #ebebeb);background-image:-o-linear-gradient(top, white, #ebebeb);background-image:linear-gradient(top, white, #ebebeb)}.sc--default svg{fill:#222}.sc--default:hover{color:#222;background-color:#d2d2d2;background-image:-webkit-linear-gradient(top, white, #d2d2d2 90%);background-image:-moz-linear-gradient(top, white, #d2d2d2);background-image:-ms-linear-gradient(top, white, #d2d2d2);background-image:-o-linear-gradient(top, white, #d2d2d2);background-image:linear-gradient(top, white, #d2d2d2);background-color:#fdfdfd}.sc--default:active{background-color:#dfdfdf;background-image:-webkit-linear-gradient(top, white, #dfdfdf 100%);background-image:-moz-linear-gradient(top, white, #dfdfdf);background-image:-ms-linear-gradient(top, white, #dfdfdf);background-image:-o-linear-gradient(top, white, #dfdfdf);background-image:linear-gradient(top, white, #dfdfdf)}.sc--facebook{background-color:#33477a;background-image:-webkit-linear-gradient(top, #5975ba, #33477a 100%);background-image:-moz-linear-gradient(top, #5975ba, #33477a);background-image:-ms-linear-gradient(top, #5975ba, #33477a);background-image:-o-linear-gradient(top, #5975ba, #33477a);background-image:linear-gradient(top, #5975ba, #33477a)}.sc--facebook:hover{background-color:#304373;background-image:-webkit-linear-gradient(top, #6b84c1, #304373 90%);background-image:-moz-linear-gradient(top, #6b84c1, #304373);background-image:-ms-linear-gradient(top, #6b84c1, #304373);background-image:-o-linear-gradient(top, #6b84c1, #304373);background-image:linear-gradient(top, #6b84c1, #304373);background-color:#4560a5}.sc--facebook:active{background-color:#33477a;background-image:-webkit-linear-gradient(top, #4a66b0, #33477a 100%);background-image:-moz-linear-gradient(top, #4a66b0, #33477a);background-image:-ms-linear-gradient(top, #4a66b0, #33477a);background-image:-o-linear-gradient(top, #4a66b0, #33477a);background-image:linear-gradient(top, #4a66b0, #33477a)}.sc--twitter{background-color:#108ac1;background-image:-webkit-linear-gradient(top, #47bbf0, #108ac1 100%);background-image:-moz-linear-gradient(top, #47bbf0, #108ac1);background-image:-ms-linear-gradient(top, #47bbf0, #108ac1);background-image:-o-linear-gradient(top, #47bbf0, #108ac1);background-image:linear-gradient(top, #47bbf0, #108ac1)}.sc--twitter:hover{background-color:#0f83b8;background-image:-webkit-linear-gradient(top, #76cdf4, #0f83b8 90%);background-image:-moz-linear-gradient(top, #76cdf4, #0f83b8);background-image:-ms-linear-gradient(top, #76cdf4, #0f83b8);background-image:-o-linear-gradient(top, #76cdf4, #0f83b8);background-image:linear-gradient(top, #76cdf4, #0f83b8);background-color:#21aded}.sc--twitter:active{background-color:#108ac1;background-image:-webkit-linear-gradient(top, #30b3ee, #108ac1 100%);background-image:-moz-linear-gradient(top, #30b3ee, #108ac1);background-image:-ms-linear-gradient(top, #30b3ee, #108ac1);background-image:-o-linear-gradient(top, #30b3ee, #108ac1);background-image:linear-gradient(top, #30b3ee, #108ac1)}.sc--google-plus{background-color:#b92d25;background-image:-webkit-linear-gradient(top, #e06b64, #b92d25 100%);background-image:-moz-linear-gradient(top, #e06b64, #b92d25);background-image:-ms-linear-gradient(top, #e06b64, #b92d25);background-image:-o-linear-gradient(top, #e06b64, #b92d25);background-image:linear-gradient(top, #e06b64, #b92d25)}.sc--google-plus:hover{background-color:#b12b23;background-image:-webkit-linear-gradient(top, #e57f79, #b12b23 90%);background-image:-moz-linear-gradient(top, #e57f79, #b12b23);background-image:-ms-linear-gradient(top, #e57f79, #b12b23);background-image:-o-linear-gradient(top, #e57f79, #b12b23);background-image:linear-gradient(top, #e57f79, #b12b23);background-color:#da4a42}.sc--google-plus:active{background-color:#b92d25;background-image:-webkit-linear-gradient(top, #dc564e, #b92d25 100%);background-image:-moz-linear-gradient(top, #dc564e, #b92d25);background-image:-ms-linear-gradient(top, #dc564e, #b92d25);background-image:-o-linear-gradient(top, #dc564e, #b92d25);background-image:linear-gradient(top, #dc564e, #b92d25)}.sc--github{background-color:#3269a0;background-image:-webkit-linear-gradient(top, #689cd0, #3269a0 100%);background-image:-moz-linear-gradient(top, #689cd0, #3269a0);background-image:-ms-linear-gradient(top, #689cd0, #3269a0);background-image:-o-linear-gradient(top, #689cd0, #3269a0);background-image:linear-gradient(top, #689cd0, #3269a0)}.sc--github:hover{background-color:#2f6498;background-image:-webkit-linear-gradient(top, #7ba9d6, #2f6498 90%);background-image:-moz-linear-gradient(top, #7ba9d6, #2f6498);background-image:-ms-linear-gradient(top, #7ba9d6, #2f6498);background-image:-o-linear-gradient(top, #7ba9d6, #2f6498);background-image:linear-gradient(top, #7ba9d6, #2f6498);background-color:#4988c6}.sc--github:active{background-color:#3269a0;background-image:-webkit-linear-gradient(top, #5490ca, #3269a0 100%);background-image:-moz-linear-gradient(top, #5490ca, #3269a0);background-image:-ms-linear-gradient(top, #5490ca, #3269a0);background-image:-o-linear-gradient(top, #5490ca, #3269a0);background-image:linear-gradient(top, #5490ca, #3269a0)}.infobox{display:table;width:100%;text-align:center}.infobox .infobox-panel{display:table-cell;vertical-align:middle;height:6rem}.infobox .infobox-panel>div{padding:.75rem}.infobox .infobox-left .infobox-content{font-size:1.5rem;padding:.2rem 0}.infobox .infobox-right{width:100%;text-align:center}.infobox .infobox-right .infobox-content{font-size:1.25rem;padding:.2rem 0}.infobox .infobox-right .infobox-content-small{font-size:1.1rem}.infobox .infobox-title{font-size:1.1rem;text-transform:uppercase}.infobox .infobox-subtitle{font-size:.9rem;text-transform:uppercase}.infobox .infobox-ip{order:1}.infobox .infobox-loc{order:2}.infobox .infobox-ping{order:3}.infobox .infobox-ua{order:4}#menubar{position:fixed;right:0;left:0;margin:0 auto;padding:0 .5rem;background-color:#fff;z-index:999}#menubar ul#menubar-left{float:left;overflow:hidden}#menubar ul#menubar-right{float:right;overflow:hidden}#menubar ul#menubar-right li{padding-left:.25rem}#menubar ul.menubar-contents{padding:.25em 0 0;margin:0;float:left;overflow:hidden}#menubar ul.menubar-contents li{display:inline}#menubar ul.menubar-contents li#menutest{text-transform:uppercase;font-weight:700;text-decoration:none;outline:0;font-size:1.35em;width:3.5em;line-height:1.15em;text-align:center;cursor:pointer}#menubar ul.menubar-contents li#menutest a{text-decoration:none;outline:0 none}p.footer{font-size:.8rem}p.footer a:link,p.footer a:visited{color:#295ba7}p.footer a:hover{color:#2893cf}@media(max-width: 641px){.sc-text{display:none}div#yestext{font-size:.8em}div#yessub{font-size:1.5em}div#yesbox{padding-top:3rem;padding-bottom:2.45rem}.infobox .infobox-left div{min-width:180px}.infobox .infobox-left .infobox-content{font-size:1.15rem}.infobox .infobox-right .infobox-content{font-size:1rem}.infobox .infobox-title{font-size:.9rem}.infobox .infobox-subtitle{font-size:.8rem}table{border-collapse:collapse;border-spacing:0;font-family:Helvetica,Arial,sans-serif;font-size:70%;margin:0 auto}th,td{padding:1px 4px;text-align:left;border:1px solid #ccc;text-align:center}}@media(max-width: 561px){table{border-collapse:collapse;border-spacing:0;font-family:Helvetica,Arial,sans-serif;font-size:60%;margin:0 auto}th,td{padding:1px 2px;text-align:left;border:1px solid #ccc;text-align:center}}@media(max-width: 481px){.responsive-small-hidden{display:none}div#yestext{font-size:.68em}div#yessub{font-size:1.25rem}div#yesbox{padding-bottom:2.25rem}.infobox{display:unset}.infobox .infobox-panel{display:unset}.infobox .infobox-panel>div{padding:.5rem}.infobox .infobox-left{border-right:none}.infobox .infobox-left .infobox-content{font-size:1.1rem}.infobox .infobox-right .infobox-content{font-size:1.1rem}.infobox .infobox-right .infobox-content-ua{font-size:.8rem}p.question{font-size:100%}ul.bodylist{text-align:left;padding-left:2.2em}}@media screen and (min-width: 0\\0 )and (min-resolution: 72dpi){#menubar{width:100%}}@media screen and (min-width: 0\\0 )and (min-resolution: 72dpi)and (max-width: 735px){#menubar{width:auto}}body{margin:0;padding:0 .5rem}p{font-family:\"Trebuchet MS\",Helvetica,sans-serif}div#center{margin:0 auto}.green{color:green}p.question{text-align:center;font-size:1.25rem;color:#006dd7}p.answer{font-family:Georgia,serif;font-size:90%;text-align:justify}p a:link,p a:visited{color:#00e}p a:hover{color:#0073ee}p a.easteregg:link,p a.easteregg:visited{text-decoration:none;color:#000}p a.easteregg:hover{text-decoration:none;color:gray}div.test-info-wrapper{padding-bottom:.75rem}div.list{width:95%}div#yesbox{text-align:center;padding-top:3.5em;padding-bottom:3.1em}div#yestext a{font-size:7em;font-weight:700;text-decoration:none;outline:0;cursor:pointer}div#yessub{font-size:200%;line-height:.1em}span#status{font-weight:700}ul.bodylist{font-family:Helvetica,Arial,sans-serif;font-size:.85rem;color:gray;text-align:justify;padding-left:3em}ul.bodylist li{padding-bottom:.3rem}ul.bodylist a:link,ul.bodylist a:visited{color:#295ba7}ul.bodylist a:hover{color:#2893cf}table{border-collapse:collapse;border-spacing:0;font-family:Helvetica,Arial,sans-serif;font-size:80%;margin:0 auto}th,td{padding:2px 12px;text-align:left;border:1px solid #ccc;text-align:center}tbody tr:nth-child(odd){background:#cce9fe}.grow{display:inline-block;-webkit-transition-duration:.3s;transition-duration:.3s;-webkit-transition-property:-webkit-transform;transition-property:transform;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-transform:translateZ(0);-ms-transform:translateZ(0);transform:translateZ(0);box-shadow:0 0 1px rgba(0,0,0,0);z-index:0}.grow:hover{-webkit-transform:scale(1.1);-ms-transform:scale(1.1);transform:scale(1.1)}p.copyright{font-size:78%;color:gray}p.copyright a:link,p.copyright a:visited{color:#295ba7}p.copyright a:hover{color:#2893cf}", ""]);
...
//const Promise = require("bluebird");
const xhr = __webpack_require__(35);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__domHelpers_js__ = __webpack_require__(7);


// save a reference to the nodes that need updating
const target_nodes = {
    ip: Object(__WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["a" /* getByClass */])("infobox-content-ip")[0],
    ip_prev: Object(__WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["a" /* getByClass */])("infobox-content-ip-prev")[0],
    ping: Object(__WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["a" /* getByClass */])("infobox-content-ping")[0],
    ping_avg: Object(__WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["a" /* getByClass */])("infobox-content-ping-avg")[0],
    location: Object(__WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["a" /* getByClass */])("infobox-content-loc")[0],
    ua: Object(__WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["a" /* getByClass */])("infobox-content-ua")[0]
}

var current_ip = null;
var prev_ip = __WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["b" /* storage */].get("infobox-prev-ip") || null;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ip: (new_ip) => {
        ...
        __WEBPACK_IMPORTED_MODULE_0__domHelpers_js__["b" /* storage */].set("infobox-prev-ip", current_ip);
    },
